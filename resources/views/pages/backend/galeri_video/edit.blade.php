<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @endif
            <div>
                <form class="w-full" action="{{ route('galeri_video.update', [$galeri_video->id]) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input type="text" name="judul" placeholder="Ketik judul di sini"
                                ...
                                id="judul" value="{{ old('judul') ?? $galeri_video->judul }}" />
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <textarea name="keterangan" class="appearance-none block w-full bg-white text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Ketik keterangan di sini">{{ old('keterangan') ?? $galeri_video->keterangan }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <span class="font-base inline-block text-xs text-red-600">Silahkan video di upload di youtube, setelah itu link taruh di form disini</span>
                                ...
                                class="appearance-none block w-full text-gray-800 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                id="path_link" value="{{ old('path_link') ?? $galeri_video->path_link }}" />
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap -m-3 mb-6">
                        <div class="w-full px-3 text-right">
                            ...
                            <button type="submit"
                                class="shadow-lg bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Update Video</button>
                        </div>
                    </div>
                </form>
            </div>
