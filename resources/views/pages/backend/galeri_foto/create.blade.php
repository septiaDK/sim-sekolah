<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @endif
            <div>
                <form class="w-full" action="{{ route('galeri_foto.store') }}" method="POST" enctype="multipart/form-data">
                    @method('POST')
                    @csrf
                    ...
                    <div class="flex flex-wrap -m-3 mb-6">
                        <div class="w-full px-3 text-right">
                            ...
                            <button type="submit"
                                class="shadow-lg bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Simpan Foto</button>
                        </div>
                    </div>
                </form>
            </div>
