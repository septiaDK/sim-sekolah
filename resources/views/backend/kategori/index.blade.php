                        ...
                        <div class="flex justify-end">
                            <div class="form-control">
                                <div class="input-group">
                                    <input type="text" name="keyword" placeholder="Pencarian…" class="input input-bordered" value="{{ Request::get('keyword') }}"/>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center w-1/4">
                                            ...
                                            <a href="{{ route('kategori.edit', [$kategori->id]) }}"
                                                class="btn bg-yellow-600 hover:bg-yellow-800 btn-sm">Ubah</a>
                                            ...
                                            <!-- modal konfirm hapus -->
                                            <input type="checkbox" id="my-modal-{{ $kategori->id }}"
                                                class="modal-toggle" />
                                            <div class="modal">
