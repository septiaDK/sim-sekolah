                    ...
                    <form action="{{ route('identitas_sekolah.store') }}" method="POST">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                ...
                                <select class="appearance-none w-full py-1 px-2 bg-white" name="bentuk_pendidikan"
                                    ...
                                    <option value="" disabled selected>--Pilih--</option>
                                    <option value="SMA" @selected(old("bentuk_pendidikan") == "SMA")>SMA</option>
                                    <option value="SMK" @selected(old("bentuk_pendidikan") == "SMK")>SMK</option>
                                    <option value="MA" @selected(old("bentuk_pendidikan") == "MA")>MA</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                ...
                                <textarea name="alamat" id="alamat" class="shadow form-textarea mt-1 block w-full border rounded border-gray-300 p-3 py-2 px-3 leading-tight focus:outline-none focus:shadow-outline" rows="5" placeholder="Ketik alamat di sini">{{ old('alamat') }}</textarea>
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                ...
                                <textarea name="sejarah" id="sejarah" class="ckeditor shadow form-textarea mt-1 block w-full border rounded border-gray-300 p-3 py-2 px-3 leading-tight focus:outline-none focus:shadow-outline" rows="5" placeholder="Ketik sejarah di sini">{{ old('sejarah') }}</textarea>
                        ...
                        <div class="flex justify-end">
                            <button type="submit"
                                class="btn bg-green-600 hover:bg-green-800 btn-sm mt-5">Simpan</button>
                        </div>
                    </form>
                </div>
            </div>
